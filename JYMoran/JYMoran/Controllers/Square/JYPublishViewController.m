    ...
    [NSURLConnection sendAsynchronousRequest:request
     ...
     ^(NSURLResponse * _Nullable response, NSData * _Nullable data, NSError * _Nullable connectionError) {
        if (connectionError) {
            ...
            self.locationModel = [[JYLocationModel alloc]init];
            JYLocationParser *parser = [[JYLocationParser alloc]init];
...
- (void)makeTableView {
    ...
    if (!self.tableView) {
        ...
        [self.tableView registerNib:[UINib nibWithNibName:@"JYPublishCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"publishCell"];
