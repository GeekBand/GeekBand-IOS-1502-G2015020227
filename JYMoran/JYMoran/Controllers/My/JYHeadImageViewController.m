...
@interface JYHeadImageViewController ()

@end

@implementation JYHeadImageViewController
...
- (IBAction)doneButtonClicked:(id)sender {
    JYEditImageRequest *request = [[JYEditImageRequest alloc]init];
...
- (void)editImageRequestSuccess:(JYEditImageRequest *)request {
    [JYGlobal shareGlobal].user.image = self.headImageView.image;
